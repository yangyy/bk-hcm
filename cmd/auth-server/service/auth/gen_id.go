...
// genLoadBalancerRelatedResources 生成负载均衡下属资源的权限点
func genLoadBalancerRelatedResources(a *meta.ResourceAttribute) (iam.ActionID, []iam.Resource, error) {
	res := iam.Resource{
		System: sys.SystemIDHCM,
		Type:   sys.Account,
	}
...
// genBizLoadBalancerRelatedResources 生成业务下负载均衡下属资源的权限点
func genBizLoadBalancerRelatedResources(a *meta.ResourceAttribute) (iam.ActionID, []iam.Resource, error) {
	res := iam.Resource{
		System: sys.SystemIDCMDB,
		Type:   sys.Biz,
	}
