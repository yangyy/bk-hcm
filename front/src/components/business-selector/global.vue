...
const businessList = ref(businessGlobalStore.businessAuthorizedList.slice());
...
<template>
  ...
  >
    ...
    <template #append>
      <div class="select-append">
        <bk-button text size="small" class="create-button" @click="createDialogShow = true">
  ...
  <bk-dialog v-model:isShow="createDialogShow" dialog-type="show" width="520">
    <bk-exception
      type="building"
      scene="part"
      title="新建业务参考以下指引"
